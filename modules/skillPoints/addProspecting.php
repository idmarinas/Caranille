...
&& isset($_POST['addWisdom']))
{
    ...
    if ($_POST['token'] == $_SESSION['token'])
    {
        ...
        if ($characterSkillPoints > 0)
        {
            ...
            <p>ATTENTION</p> 
            Vous êtes sur le point d'attribuer 1 point en prospection à votre personnage pour 1 PC.<br />
            Confirmez-vous ?

            <hr>
                
            <form method="POST" action="addProspectingEnd.php">
