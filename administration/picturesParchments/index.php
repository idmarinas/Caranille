...
<form method="POST" action="manageParchmentsPicture.php">
    Images de parchemins : <select name="pictureFile" class="form-control">
...
<form method="POST" action="addParchmentsPicture.php" enctype="multipart/form-data">
